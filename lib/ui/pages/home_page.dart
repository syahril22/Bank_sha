...
// widget section latest transictons
...
// widget section friendly Tips
  Widget buildFrendlyTips() {
    return Container(
      margin: const EdgeInsets.only(
        top: 30,
        bottom: 50,
